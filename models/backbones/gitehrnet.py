    ...
    def __init__(self, channels, stride, num_branch, num_groups, num_kernels, with_cp=False):
        ...
        self.conv = nn.ModuleList([
            ...
            for i in range(self.num_groups)
                ...
                nn.Conv2d(self.split_channels[-1], self.split_channels[-1], dw_size=3, stride=1, padding=1, groups=self.split_channels[-1], bias=False),
    ...
    def forward(self, x):
        ...
        def _inner_forward(x):
            if self.num_groups == 1:
                ...
                x_split = torch.split(x, self.split_channels, dim=1) # 前一块代码应该排序，把注意力排序不行的通道放到后边
